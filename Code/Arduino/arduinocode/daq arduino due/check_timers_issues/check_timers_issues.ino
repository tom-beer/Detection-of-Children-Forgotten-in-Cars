...
void setup() {
  ...
  adc_setup ();
  tmr_setup ();
  Timer2.attachInterrupt(timerisr).setFrequency(100).start();
  Timer3.attachInterrupt(timerisr2).setFrequency(150).start();
  Timer4.attachInterrupt(timerisr3).setFrequency(20);
}
